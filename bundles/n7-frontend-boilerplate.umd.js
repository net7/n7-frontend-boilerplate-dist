    ...
    ***************************************************************************** */
    ...
    var AwEntitaLayoutDS = /** @class */ (function (_super) {
        ...
        function (res) {
            ...
            this.myResponse = res;
            /** @type {?} */
            var allowedOverviewMetadata = lodash.get(this.configuration.get('entita-layout'), 'overview.campi', []);
            if ((res.fields || [])
                .filter((/**
             * @param {?} field
             * @return {?}
        ...
        function (data) {
            ...
            */
            ...
            if (context === 'overview' && data) {
                /** @type {?} */
                var configuredKeys_1 = lodash.get(config.get('entita-layout'), 'overview.campi', []);
                /** @type {?} */
    ...
    var AwTreeEH = /** @class */ (function (_super) {
        ...
        function AwTreeEH() {
            ...
            function () {
                 ...
                 * @return {?}
                 */
                function (data) { return !!data; })), operators.first(), operators.withLatestFrom(_this.targetOffset)).subscribe((/**
                 * @param {?} __0
                 * @return {?}
                 */
                function (_a) {
            ...
            function (_a) {
                ...
                switch (type) {
                    ...
                    case 'aw-scheda-layout.viewleaf':
                         ...
                         * @return {?}
                         */
                        function (data) { return !!data; })), operators.first()).subscribe((/**
                         * @return {?}
                         */
                        function () {
                            _this.scrollLeafIntoView();
        ...
        function () {
            ...
            function (params) {
                ...
                if (paramId) {
                    ...
                    _this.dataSource.loadItem(paramId)
                        .pipe(
                    // filter empty metadata values
                    operators.map((/**
                     * @param {?} response
                    ...
                    function (response) {
                        if (response.fields) {
                            ...
                            function (item) {
                                if (item.fields) {
                                    filteredFields_1.push(__assign({}, item, { fields: item.fields
                                            .filter((/**
                                         * @param {?} __0
                                         * @return {?}
                                         */
                                        function (_a) {
                                            var subValue = _a.value;
                                            return !helpers.metadataIsEmpty(subValue);
                                        })) }));
                                }
                                else if (!helpers.metadataIsEmpty(item.value)) {
                                    filteredFields_1.push(item);
                                }
                            }));
                            response.fields = filteredFields_1;
                        }
                        return response;
                    })))
                        .subscribe((/**
    ...
    var EscapeHtmlPipe = /** @class */ (function () {
        ...
        EscapeHtmlPipe.decorators = [
            { type: core.Pipe, args: [{ name: 'keepHtml', pure: false },] }
        ];
        /** @nocollapse */
     ...
     */
    var homeMock = {
        'slider-1': components.CAROUSEL_MOCK,
        'collection-1': {
            header: {
                title: 'Le mappe',
    ...
    var MrHeroDS = /** @class */ (function (_super) {
        ...
        function (data) {
            ...
            return __assign({}, data, { classes: classes, backgroundImage: back, image: image || '' });
        };
        return MrHeroDS;
    }(core$1.DataSource));
    if (false) {
    ...
    var MrSliderDS = /** @class */ (function (_super) {
         ...
         * @return {?}
         */
        MrSliderDS.prototype.transform = /**
         * @protected
         * @param {?} data
         * @return {?}
         */
    ...
    var MrCollectionDS = /** @class */ (function (_super) {
        ...
        function (data) {
            ...
            return {
                 ...
                 * @return {?}
                 */
                function (item) { return (__assign({}, item, { classes: classes || '' })); }))
            };
        };
    ...
    var MrCollectionEH = /** @class */ (function (_super) {
         ...
         * @return {?}
         */
        MrCollectionEH.prototype.listen = /**
         * @return {?}
         */
        function () {
            // this.innerEvents$.subscribe(({ type, payload }) => {
    ...
    var MrSearchService = /** @class */ (function () {
        ...
        function (context, id, newValue) {
            var _a;
            this.contextState[context] = __assign({}, this.contextState[context], (_a = {}, _a["" + id] = newValue, _a));
        ...
        function () {
            ...
            function (params) {
                ...
                return params;
            })), operators.debounceTime(results.delay || 1), operators.map((/**
             * @param {?} params
             * @return {?}
             */
            function (params) {
            ...
            function (state) { return _this.communication.request$(results.id, {
                params: __assign({}, state, { searchId: _this.searchId }),
                method: 'POST',
                onError: (/**
                 * @param {?} error
                 * @return {?}
        ...
        function () {
            var _this = this;
            this.getState$(INPUT_STATE_CONTEXT).pipe(operators.filter((/**
             * @param {?} __0
             * @return {?}
             */
            function (_a) {
        ...
        function () {
            ...
            this.getState$(RESULTS_REQUEST_STATE_CONTEXT, 'loading').pipe(operators.map((/**
             * @param {?} params
             * @return {?}
             */
            function (params) {
                ...
                return params;
            })), operators.debounceTime(facets.delay || 1), operators.map((/**
             * @param {?} params
             * @return {?}
             */
            function (params) {
    ...
    var MrSearchLayoutEH = /** @class */ (function (_super) {
        ...
        function () {
            ...
            function (response) {
                ...
                // update layout state
                _this.dataSource.setSectionState('results', lodash.isEmpty(response.results) ? 'EMPTY' : 'OK');
            }));
        };
    ...
    var MrSearchLayoutComponent = /** @class */ (function (_super) {
        ...
        function MrSearchLayoutComponent(layoutsConfiguration, router, activatedRoute, communication, configuration, searchService) {
            ...
            _this.hostEmit$ = new rxjs.Subject();
            _this.guestEmit$ = new rxjs.Subject();
            return _this;
        }
        /**
         * @protected
    ...
    var MrStaticLayoutEH = /** @class */ (function (_super) {
        ...
        function () {
            var _this = this;
            this.route.paramMap.pipe(operators.takeUntil(this.destroy$), operators.map((/**
             * @param {?} params
             * @return {?}
             */
            function (params) { return params.get('slug'); })), operators.switchMap((/**
             * @param {?} slug
             * @return {?}
             */
    ...
    var SearchFacetsLayoutDS = /** @class */ (function (_super) {
        ...
        function (id, newData) {
            /** @type {?} */
            var ds = this.inputsDS[id];
            ds.update(__assign({}, ds.input, newData));
            // refresh selected
    ...
    var SearchFacetsLayoutEH = /** @class */ (function (_super) {
        ...
        function (_a) {
            ...
            function (section) {
                ...
                function (source) {
                    ...
                    _this.changed$[source.id].pipe(operators.debounceTime(source.delay || 1)).subscribe((/**
                     * @param {?} __0
                     * @return {?}
                     */
                    function (_a) {
        ...
        function () {
            ...
            this.searchService.getState$(FACETS_REQUEST_STATE_CONTEXT, 'success')
                .pipe(operators.takeUntil(this.destroyed$)).subscribe((/**
             * @param {?} __0
             * @return {?}
             */
            function (_a) {
    ...
    var FacetLinkDS = /** @class */ (function (_super) {
        ...
        function (value, update) {
            ...
            if (update) {
                 ...
                 * @return {?}
                 */
                function (link) { return (__assign({}, link, { classes: _this.value === link.payload ? ACTIVE_CLASS : '' })); }));
    ...
    var FacetHeaderDS = /** @class */ (function (_super) {
         ...
         */
        function (data) {
            return __assign({}, data, { iconRight: data.iconRight || ICON_OPEN });
        };
        /**
         * @param {?} value
         * @param {?=} update
        ...
        function (value, update) {
            ...
            this.value = value;
            if (update) {
                this.update(__assign({}, this.input, { additionalText: value }));
            }
        };
        /**
         * @return {?}
        ...
        function () {
            ...
            this.update(__assign({}, this.input, { iconRight: iconRight }));
        };
        /**
         * @return {?}
         */
    ...
    var FacetCheckboxEH = /** @class */ (function (_super) {
         ...
         * @return {?}
         */
        FacetCheckboxEH.prototype.listen = /**
         * @return {?}
         */
        function () {
            var _this = this;
    ...
    var FacetLinkMultipleDS = /** @class */ (function (_super) {
        ...
        function (value, update) {
            ...
            if (update) {
                 ...
                 * @return {?}
                 */
                function (link) { return (__assign({}, link, { classes: _this.value.includes(link.payload) ? ACTIVE_CLASS$1 : '' })); }));
                this.update(__assign({}, this.input, { links: updatedLinks }));
            }
        };
        /**
    ...
    var MrMenuService = /** @class */ (function () {
        ...
        function (path, rootPath) {
             ...
             * @return {?}
             */
            function () { return rxjs.of(null); })), operators.tap((/**
             * @param {?} response
             * @return {?}
             */
        ...
        /** @nocollapse */ MrMenuService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function MrMenuService_Factory() { return new MrMenuService(core.ɵɵinject(http.HttpClient), core.ɵɵinject(ConfigurationService)); }, token: MrMenuService, providedIn: "root" });
    ...
    exports.ɵba = MrSearchService;
    exports.ɵbb = MrGlossaryLayoutComponent;
    exports.ɵbc = MrStaticLayoutComponent;
    exports.ɵbd = MrSearchFacetsLayoutComponent;
    ...
    exports.ɵx = EscapeHtmlPipe;
    exports.ɵy = MrHomeLayoutComponent;
    exports.ɵz = MrSearchLayoutComponent;
