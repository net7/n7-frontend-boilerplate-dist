(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/common/http'), require('@n7-frontend/components'), require('rxjs'), require('rxjs/operators'), require('@angular/router'), require('@angular/platform-browser'), require('@n7-frontend/core'), require('tippy.js'), require('lodash'), require('slugify'), require('leaflet'), require('moment')) :
    typeof define === 'function' && define.amd ? define('@n7-frontend/boilerplate', ['exports', '@angular/core', '@angular/common', '@angular/common/http', '@n7-frontend/components', 'rxjs', 'rxjs/operators', '@angular/router', '@angular/platform-browser', '@n7-frontend/core', 'tippy.js', 'lodash', 'slugify', 'leaflet', 'moment'], factory) :
    (global = global || self, factory((global['n7-frontend'] = global['n7-frontend'] || {}, global['n7-frontend'].boilerplate = {}), global.ng.core, global.ng.common, global.ng.common.http, global.components, global.rxjs, global.rxjs.operators, global.ng.router, global.ng.platformBrowser, global.core$1, global.tippy, global.lodash, global.slugify, global.leaflet, global.moment));
}(this, (function (exports, core, common, http, components, rxjs, operators, router, platformBrowser, core$1, tippy, lodash, slugify, leaflet, moment) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var MrStaticLayoutEH = /** @class */ (function (_super) {
        ...
        MrStaticLayoutEH.prototype.listenRoute = function () {
            ...
            this.route.url.pipe(operators.takeUntil(this.destroy$), operators.tap(function () {
                _this.layoutState.set('content', LayoutState.LOADING);
            }), operators.switchMap(function (url) { return _this.dataSource.pageRequest$(url[0].path, function (err) {
    ...
    var MrTimelineLayoutDS = /** @class */ (function (_super) {
        ...
        MrTimelineLayoutDS.prototype.onInit = function (payload) {
            ...
            this.getWidgetDataSource('mr-timeline').timelineLoaded$.pipe(operators.first()).subscribe(function (timeline) {
    ...
    exports.SbDummyDS = SbDummyDS;
    exports.SbDummyEH = SbDummyEH;
    ...
    exports.ɵba = MrGlossaryLayoutComponent;
    ...
    exports.ɵbk = MrTimelineLayoutComponent;
    exports.ɵbl = ReadMoreComponent;
    exports.ɵbm = MrFormComponent;
    exports.ɵbn = MrFormWrapperAccordionComponent;
    exports.ɵbo = MrSearchPageDescriptionComponent;
    exports.ɵbp = MrResourceModalComponent;
    exports.ɵbq = SbExampleLayoutComponent;
    ...
    exports.ɵw = DataWidgetWrapperComponent;
    exports.ɵx = DatepickerWrapperComponent;
    exports.ɵy = DvExampleLayoutComponent;
    exports.ɵz = EscapeHtmlPipe;
