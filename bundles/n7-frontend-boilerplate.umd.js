(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var ApolloProvider = /** @class */ (function () {
        ...
        ApolloProvider.ɵprov = core.ɵɵdefineInjectable({ factory: function ApolloProvider_Factory() { return new ApolloProvider(core.ɵɵinject(http.HttpClient), core.ɵɵinject(ConfigurationService)); }, token: ApolloProvider, providedIn: "root" });
    ...
    var getSeries = function (series) { return series.map(function (_a) {
        ...
        return ({
            id: id,
            name: name,
            data: data.map(function (point) { return (lodash.isObject(point) ? point.value : point); })
        });
    }); };
    var ɵ0$2 = getSeries;
    ...
    var MapItemDS = /** @class */ (function (_super) {
        ...
        MapItemDS.prototype.update = function (newData) {
            var _this = this;
            if (!this.instance) {
                var formattedData = lodash.merge({
    ...
    var MrSearchService = /** @class */ (function () {
        ...
        MrSearchService.prototype.onResultsLoading = function () {
            ...
            this.getState$(RESULTS_REQUEST_STATE_CONTEXT, 'loading').pipe(operators.map(function (params) {
                ...
                return params;
            }), operators.switchMap(function (state) {
                var initializeRequest$ = rxjs.of(true);
                if (_this.initializeKeys.length && lodash.isEmpty(_this.initializeValues)) {
                ...
                return initializeRequest$.pipe(operators.tap(function (response) {
                    if (response.facets) {
                ...
                }), operators.switchMapTo(rxjs.of(state)));
        ...
        MrSearchService.prototype.onFacetsRequestSuccess = function (response) {
            var _this = this;
            var responseFacets = response.facets;
            if (!lodash.isEmpty(this.initializeValues)) {
    ...
    var FacetMapDS = /** @class */ (function (_super) {
        ...
        function FacetMapDS() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.value = [];
            _this.markerEvents$ = new rxjs.Subject();
            _this.isUpdate = false;
    ...
    exports.ApexChartItemDS = ApexChartItemDS;
    exports.ApexHandler = ApexHandler;
    ...
    exports.DvCardExampleLayoutComponent = DvCardExampleLayoutComponent;
    exports.DvCardExampleLayoutConfig = DvCardExampleLayoutConfig;
    exports.DvCardExampleLayoutDS = DvCardExampleLayoutDS;
    exports.DvCardExampleLayoutEH = DvCardExampleLayoutEH;
    ...
    exports.InnerTitleItemDS = InnerTitleItemDS;
    ...
    exports.SelectItemDS = SelectItemDS;
    ...
    exports.TableItemDS = TableItemDS;
    exports.TextItemDS = TextItemDS;
    exports.apexHandler = apexHandler;
    exports.ɵ0 = ɵ0$2;
    exports.ɵ1 = ɵ1$1;
    ...
    exports.ɵbb = CardComponent;
    exports.ɵbc = CardTextItemComponent;
    exports.ɵbd = DvExampleLayoutComponent;
    exports.ɵbe = DvCardExampleLayoutComponent;
    exports.ɵbf = EscapeHtmlPipe;
    exports.ɵbg = MrAdvancedResultsLayoutComponent;
    exports.ɵbh = MrLayoutStateService;
    exports.ɵbi = MrResourceModalService;
    exports.ɵbj = MrAdvancedSearchLayoutComponent;
    exports.ɵbk = MrGlossaryLayoutComponent;
    exports.ɵbl = MrHomeLayoutComponent;
    exports.ɵbm = MrItineraryLayoutComponent;
    exports.ɵbn = MrMapLayoutComponent;
    exports.ɵbo = MrPostsLayoutComponent;
    exports.ɵbp = MrResourceLayoutComponent;
    exports.ɵbq = MrSearchFacetsLayoutComponent;
    exports.ɵbr = MrSearchLayoutComponent;
    exports.ɵbs = MrSearchService;
    exports.ɵbt = MrStaticLayoutComponent;
    exports.ɵbu = MrTimelineLayoutComponent;
    exports.ɵbv = ReadMoreComponent;
    exports.ɵbw = MrFormComponent;
    exports.ɵbx = MrFormWrapperAccordionComponent;
    exports.ɵby = MrSearchPageDescriptionComponent;
    exports.ɵbz = MrResourceModalComponent;
    exports.ɵc = ConfigurationService;
    exports.ɵca = MrGalleryComponent;
    exports.ɵcb = MrAdvancedResultComponent;
    exports.ɵcc = SbExampleLayoutComponent;
    exports.ɵcd = SbImageViewerLayoutComponent;
