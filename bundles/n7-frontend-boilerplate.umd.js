        ...
        function AwLinkedObjectsDS() {
            ...
            function (data) {
                ...
                function (el) {
                    ...
                    /** @type {?} */
                    var breadcrumbs = lodash.get(el, paths.metadata.breadcrumbs.data, el.item.breadcrumbs);
                    ...
                    /** @type {?} */
                    var itemTitle = +paths.title.maxLength && lodash.get(el, paths.title, el.item.label).length > +paths.title.maxLength
                    ...
                    var item = {
                        ...
                        payload: { id: lodash.get(el, paths.payload, el.item.id), type: el.item.typeOfEntity, title: itemTitle },
                        classes: classes,
        ...
        function (data) {
            ...
            */
            ...
            /*
              ...
              "smallView" is used for a compressed view of the same data.
            */
            return __assign({}, commonParams, { data: this.smartSlice(data), smallView: __assign({}, commonParams, { data: this.smartSlice(data, smallChartSize) }) });
        };
