(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@n7-frontend/boilerplate', ['exports', '@angular/core', '@angular/common', '@angular/common/http', '@n7-frontend/components', 'rxjs', 'rxjs/operators', '@angular/router', '@angular/platform-browser', '@n7-frontend/core', 'tippy.js', 'lodash', 'slugify', 'ngx-extended-pdf-viewer', 'leaflet', 'moment', '@n7-frontend/core/dist/layout-data-source'], factory) :
    (global = global || self, factory((global['n7-frontend'] = global['n7-frontend'] || {}, global['n7-frontend'].boilerplate = {}), global.ng.core, global.ng.common, global.ng.common.http, global.components, global.rxjs, global.rxjs.operators, global.ng.router, global.ng.platformBrowser, global.core$1, global.tippy, global.lodash, global.slugify, global.ngxExtendedPdfViewer, global.leaflet, global.moment, global.layoutDataSource));
}(this, (function (exports, core, common, http, components, rxjs, operators, router, platformBrowser, core$1, tippy, lodash, slugify, ngxExtendedPdfViewer, leaflet, moment, layoutDataSource) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var MrInputCheckboxDS = /** @class */ (function (_super) {
        ...
        MrInputCheckboxDS.prototype.getCheckboxes = function (checkboxes) {
            ...
            return checkboxes.map(function (checkbox) { return (__assign(__assign({}, checkbox), { disabled: disabled, label: core$1._t(checkbox.label), checked: !!(value.includes(checkbox.payload)) })); });
        };
    ...
    exports.ɵba = DvExampleLayoutComponent;
    exports.ɵbb = EscapeHtmlPipe;
    exports.ɵbc = MrGlossaryLayoutComponent;
    exports.ɵbd = MrHomeLayoutComponent;
    exports.ɵbe = MrLayoutStateService;
    exports.ɵbf = MrResourceLayoutComponent;
    exports.ɵbg = MrResourceModalService;
    exports.ɵbh = MrSearchFacetsLayoutComponent;
    exports.ɵbi = MrSearchLayoutComponent;
    ...
    exports.ɵbp = ReadMoreComponent;
    exports.ɵbq = MrFormComponent;
    exports.ɵbr = MrFormWrapperAccordionComponent;
    exports.ɵbs = MrSearchPageDescriptionComponent;
    exports.ɵbt = MrResourceModalComponent;
    exports.ɵbu = SbExampleLayoutComponent;
    exports.ɵbv = SbImageViewerLayoutComponent;
    ...
    exports.ɵl = AwGalleryLayoutComponent;
    exports.ɵm = AwSearchService;
    exports.ɵn = AwHomeLayoutComponent;
    exports.ɵo = AwMapLayoutComponent;
    exports.ɵp = AwSchedaLayoutComponent;
    exports.ɵq = AwSearchLayoutComponent;
    exports.ɵr = AwTimelineLayoutComponent;
    exports.ɵs = BubbleChartWrapperComponent;
    exports.ɵt = ChartTippyComponent;
    exports.ɵu = SmartBreadcrumbsComponent;
    exports.ɵv = AwFacetsWrapperComponent;
    exports.ɵw = PdfViewerComponent;
    exports.ɵx = SchedaDropdownComponent;
    exports.ɵy = DataWidgetWrapperComponent;
    exports.ɵz = DatepickerWrapperComponent;
