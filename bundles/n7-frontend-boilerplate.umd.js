        ...
        function AwLinkedObjectsDS() {
            ...
            function (data) {
                ...
                function (el) {
                    ...
                    /** @type {?} */
                    var itemTitle = +paths.title.maxLength && lodash.get(el, paths.title, itemData.label).length > +paths.title.maxLength
                        ? lodash.get(el, paths.title, itemData.label).slice(0, +paths.title.maxLength) + '…'
                    ...
                    var item = {
                        ...
                        text: !paths.text ? null : // make text block (in config) optional
                            +paths.text.maxLength && lodash.get(el, paths.text.data, itemData.text).length > +paths.text.maxLength ?
                                lodash.get(el, paths.text.data, itemData.text).slice(0, +paths.text.maxLength) + '…' :
                                lodash.get(el, paths.text.data, itemData.text),
                        anchor: {
                            href: itemHref
                        },
